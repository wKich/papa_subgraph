...
export class sPapaERC20__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class sPapaERC20 extends ethereum.SmartContract {
  static bind(address: Address): sPapaERC20 {
    return new sPapaERC20("sPapaERC20", address);
  }
  ...
  rebases(param0: BigInt): sPapaERC20__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new sPapaERC20__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(param0: BigInt): ethereum.CallResult<sPapaERC20__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
