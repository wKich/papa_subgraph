...
export class PapaStaking__epochResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PapaStaking__warmupInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class PapaStaking extends ethereum.SmartContract {
  static bind(address: Address): PapaStaking {
    return new PapaStaking("PapaStaking", address);
  }
  ...
  epoch(): PapaStaking__epochResult {
    let result = super.call(
      "epoch",
    ...
    return new PapaStaking__epochResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_epoch(): ethereum.CallResult<PapaStaking__epochResult> {
    let result = super.tryCall(
      "epoch",
      "epoch():(uint256,uint256,uint256,uint256)",
      []
  ...
  sPAPA(): Address {
    let result = super.call("sPAPA", "sPAPA():(address)", []);

    return result[0].toAddress();
  }

  try_sPAPA(): ethereum.CallResult<Address> {
    let result = super.tryCall("sPAPA", "sPAPA():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  warmupInfo(param0: Address): PapaStaking__warmupInfoResult {
    let result = super.call(
      "warmupInfo",
    ...
    return new PapaStaking__warmupInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_warmupInfo(
    param0: Address
  ): ethereum.CallResult<PapaStaking__warmupInfoResult> {
    let result = super.tryCall(
      "warmupInfo",
      "warmupInfo(address):(uint256,uint256,uint256,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PapaStaking__warmupInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
